                ...
                <main class="mt-6 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="text-center lg:text-left">
                        ...
                        <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl animate-fade-in">
                            <span class="block">Tingkatkan</span>
                            <span class="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">gaya hidup digital Anda</span>
                        </h1>
                        <p class="mt-3 text-sm sm:text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 animate-fade-in-up">
                            Temukan laptop dan desktop performa tinggi terkini untuk bekerja, gaming, dan kreativitas. Kualitas premium, harga terjangkau.
                        </p>
                        ...
                        <div class="mt-8 sm:mt-12 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-8">
                            <div class="text-center">
                                ...
                                <div class="text-xs sm:text-sm text-gray-500 mt-1">Pelanggan Puas</div>
                            </div>
                            <div class="text-center">
                            ...
                            <div class="text-center">
                                ...
                                <div class="text-xs sm:text-sm text-gray-500 mt-1">Dukungan</div>
                            </div>
                        </div>
                    </div>
                </main>
    ...
    <div id="featured" class="py-16 bg-gray-50 scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <p class="text-xs sm:text-sm font-semibold text-indigo-600 uppercase tracking-wide">Terlaris</p>
                ...
                <p class="mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base lg:text-lg text-gray-500 mx-auto">
                    Pilihan terbaik dari produk komputer dengan rating tertinggi.
                </p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                <div class="text-center">
                    ...
                    <h3 class="mt-6 text-lg font-medium text-gray-900">Kualitas Terjamin</h3>
                    <p class="mt-2 text-base text-gray-500">Setiap mesin diuji secara ketat untuk performa maksimal.</p>
                </div>
                <div class="text-center">
                    <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white mx-auto">
                    ...
                    <p class="mt-2 text-base text-gray-500">Gratis pengiriman ekspres untuk semua pesanan di atas Rp 15.000.000.</p>
                </div>
                <div class="text-center">
                    <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white mx-auto">
                    ...
                    <h3 class="mt-6 text-lg font-medium text-gray-900">Dukungan 24/7</h3>
                    <p class="mt-2 text-base text-gray-500">Tim ahli kami siap membantu Anda kapan saja.</p>
                </div>
            </div>
        </div>
    </div>
