        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 sm:p-8 text-center border-b border-gray-100">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Pembayaran Berhasil!</h3>
                    <p class="text-sm sm:text-base text-gray-600">Pesanan Anda telah dikonfirmasi dan sedang diproses.</p>
                </div>
                ...
                <div class="p-4 sm:p-8">
                    ...
                    <!-- Items -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold text-gray-900 mb-4">Produk Dipesan</h4>
                        <div class="space-y-3">
                    ...
                    <div class="border-t border-gray-200 pt-4 mb-6">
                        <div class="flex justify-between items-center">
                            <span class="text-base font-semibold text-gray-900">Total Dibayar</span>
                    ...
                    <!-- Shipping Address -->
                    <div class="mb-8">
                        <h4 class="text-sm font-semibold text-gray-900 mb-2">Alamat Pengiriman</h4>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                Email konfirmasi telah dikirim ke alamat email terdaftar Anda. Anda dapat melacak status pesanan di bagian "Pesanan Saya".
                            </p>
                        </div>
                    </div>
                </div>
