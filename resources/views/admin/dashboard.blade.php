        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div class="bg-white overflow-hidden shadow-sm rounded-xl p-4 sm:p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4">
                            <div class="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Total Pesanan</div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl p-4 sm:p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4">
                            <div class="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Total Pendapatan</div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl p-6 border border-gray-100">
                    <div class="flex items-center justify-between w-full">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-500 uppercase tracking-wider">Total Produk</div>
                                <div class="text-2xl font-bold text-gray-900">{{ $totalProducts }}</div>
                            </div>
                        </div>
                        <a href="{{ route('admin.products.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-900 hover:bg-indigo-50 px-3 py-1 rounded-md transition-colors">Kelola &rarr;</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
                <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Pesanan Terkini</h3>
                </div>
